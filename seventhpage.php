<?php
    ...
    if (isset($_POST["submit"])) { 
        ...
        select * from `page7` where `email` = '$email'
        ");
        ...
        if($data){
            ...
            delete from `page7` where `email`='$email'
            ");
            $deleteUser->execute();
        }

        $insertjson = $conn->prepare("insert into `page7` (`email`,`jsondata`) values ('$email','$jsondata')");
        $insertjson->execute();
        
        if ($insertjson) {
            echo "Inserted successfully";
            header("Location: /DBMSform/eighthpage.php");
        }  
    }
      ...
      <div class="col-md-12">
        ...
        <div class="panel-heading">14. Significant research contribution and future plans *<small class="pull-right">(not more than 500 words)</small> <br /><small>(Please provide a Research Statement describing your research plans and one or two specific research projects to be conducted at IIT Indore in 2-3 years time frame)</small></div>
          <div class="panel-body">
            <textarea style="height:150px" placeholder="Significant research contribution and future plans" class="form-control input-md" name="research_statement" maxlength="3500" required=""><p>scnsknaskcmbakcm</p>
</textarea>
...
<div class="col-md-10">
  ...
  <a href="./sixthpage.php" class="btn btn-primary pull-left">Back</a>
