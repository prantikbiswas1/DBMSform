...
$create_table_page2->execute();
    ...
    if (isset($_POST["submit"])) { 
        ...
        select * from `page8` where `email` = '$email'
        ");
        ...
        if($data){
            ...
            delete from `page8` where `email`='$email'
            ");
            $deleteUser->execute();
        }

        $insertjson = $conn->prepare("insert into `page8` (`email`,`jsondata`) values ('$email','$jsondata')");
        $insertjson->execute();
   ...
   <div class="row">
          ...
          <div class="panel panel-info">
            <div class="panel-heading">Upload 5 Best Research Papers in a single PDF < 6MB 
             <a href="https://ofa.iiti.ac.in/facrec_che_2023_july_02/attach/711_Ma_Agarwal_1698348165/711_best_5_1715017016492155.docx" class="btn-sm btn-info " target="_blank">View Uploaded File </a>
              <br />
              <br />
  ...
  <div class="panel-heading">Check List of the documents attached with the online application (Documents should be uploaded in PDF format only):
    ...
    <div class="panel-body">
     ...
     <!-- phd certificate  -->
      <div class="col-md-4">
    <div class="panel panel-info">
      <div class="panel-heading">PHD Certificate <a href="https://ofa.iiti.ac.in/facrec_che_2023_july_02/attach/711_Ma_Agarwal_1698348165/711_phd_1715017092777306.css" class="btn-sm btn-info " target="_blank">View Uploaded File </a></div>
        <div class="panel-body">
...
<div class="col-md-10">
  ...
  <a href="./seventhpage.php" class="btn btn-primary pull-left">Back</a>
