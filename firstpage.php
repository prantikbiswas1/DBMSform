<?php
    ...
    if(isset($_POST['fname'])){
        ...
        if($data){
            ...
            delete from `page1` where `email`='$email'
            ");
            $deleteUser->execute();
        ...
        values ('$email','$adv_num','$doa','$ref_num','$post','$dept','$fname','$mname','$lname',
        '$nationality','$dob','$gender','$mstatus','$category','$id_proof','$id_photo','$father_name',
        '$photo','$CStreet','$CCity','$CState','$CCountry','$CPin','$PStreet','$PCity','$PState',
        '$PCountry','$PPin','$mobile','$mobile_2','$email_2','$landline')
        ");
