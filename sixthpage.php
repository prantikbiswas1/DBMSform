<?php
    ...
    if (isset($_POST["submit"])) { 
        ...
        select * from `page6` where `email` = '$email'
        ");
        ...
        if($data){
            ...
            delete from `page6` where `email`='$email'
            ");
            $deleteUser->execute();
        }

        $insertjson = $conn->prepare("insert into `page6` (`email`,`jsondata`) values ('$email','$jsondata')");
        $insertjson->execute();
        
        if ($insertjson) {
            echo "Inserted successfully";
            header("Location: /DBMSform/seventhpage.php");
        }  
    }
...
<!-- Bachelor Theses supervision -->
      ...
      <!-- Courses Taken -->
            ...
            <div class="form-group">
              ...
              <div class="col-md-1">
              <a href="./fifthpage.php" class="btn btn-primary pull-left">Back</a>
              </div>
